...
/*
    ...
    companion object {
        ...
        val VERTRAGSPARTNER1 = GeschaeftspartnerImpl(name1 = "vp1", partneradresse = ADRESSE)
        val VERTRAGSPARTNER2 = GeschaeftspartnerImpl(name1 = "vp2", partneradresse = ADRESSE)
